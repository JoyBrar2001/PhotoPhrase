          ...
          <div className="flex items-center justify-center h-full w-full">
            <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="text-xs text-zinc-500">.jpg, .png, .jpeg, etc (up to 5MB)</p>
              </div>
...
const UploadButton = () => {
  ...
  return (
    ...
    >
      <DialogTrigger className="bg-blue-600 px-3 py-2 text-white font-semibold rounded-md" onClick={() => setIsOpen(true)}>
        Upload Image
      </DialogTrigger>
